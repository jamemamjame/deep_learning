...
look_back = 3
trainX, trainY = create_dataset(trainset, look_back=look_back)
testX, testY = create_dataset(testset, look_back=look_back)

model = create_model(input_dim=look_back)
model.fit(x=trainX, y=trainY, batch_size=2, epochs=400, verbose=2)
